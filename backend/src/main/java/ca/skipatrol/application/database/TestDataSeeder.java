    ...
    private void seedTestPostData() {
        {
            ...
            if (testPost.isEmpty()) {
                ...
                newTestPost.setBody("According to all known laws of aviation, there is no way that a bee should be able to fly. Its wings are too small to get its fat little body off the ground. The bee, of course, flies anyways. Because bees don't care what humans think is impossible.");
        ...
        for (long currentPostCount = this.postRepository.count(); currentPostCount < requiredTestPostCount; currentPostCount++) {
            int titleLength = 6;
            int bodyLength = 20;
