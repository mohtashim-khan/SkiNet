...
const ShadowUserTable = ({ currentShift,
    setCurrentShift,
    setProxySelect,
    shadowList,
    session_data,
    ...
    const shadowUsersToRender = () => {
        ...
        return shadowList.map(shadowUser => (
            <tr key={i++}>
                ...
                <td className='userText'>{shadowUser.area === null? "Area Not Set": shadowUser.area.areaname}</td>
                <td className='userText'>{shadowUser.shadowing === null? "Not Assigned": shadowUser.shadowing.firstName+" "+shadowUser.shadowing.lastName}</td>
